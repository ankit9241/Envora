...
const featureCards = [
  ...
  },
  {
    ...
    description:
      "Logical grouping of variables by environment or microservice.",
  },
  {
    icon: Key,
    title: "Credentials manager",
    description:
      "Dedicated fields for SSH keys, private keys, and certificates.",
  },
  {
    icon: StickyNote,
    title: "Developer notes",
    description:
      "Contextual documentation attached directly to your variable blocks.",
  },
  {
    icon: Download,
    title: ".env import/export",
    description:
      "Seamless migration from existing workflows with two-click exports.",
  },
  {
    icon: Copy,
    ...
    <div className="relative min-h-screen bg-white text-gray-800 antialiased">
      ...
      <nav className="fixed top-0 w-full z-50 bg-white border-b border-gray-200 flex justify-between items-center px-8 py-4 max-w-full font-['Inter'] antialiased tracking-tight">
        ...
        <div className="flex items-center space-x-4">
          <Link
            to="/login"
            className="text-gray-600 hover:text-gray-900 transition-colors duration-200 scale-95 active:opacity-80"
          >
            Sign In
          </Link>
          <Link
            to="/register"
            className="bg-blue-600 text-white px-4 py-1.5 rounded-3xl font-medium scale-95 active:opacity-80 transition-transform hover:bg-blue-700"
          >
            Get Started
          </Link>
        </div>
        ...
        <section className="w-full px-8 pt-20 pb-32 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center bg-gray-50">
          <div className="space-y-8">
            ...
            <p className="text-gray-700 leading-relaxed">
              Envora is a structured developer vault to manage environment
              variables, credentials, notes, and project sections without losing
              track.
            </p>
          ...
          <div className="relative group hidden lg:flex">
            <div className="bg-[#11192c] border border-[#697596]/10 rounded-3xl overflow-hidden technical-glow">
              <div className="flex items-center gap-2 px-4 py-3 bg-[#151f36] border-b border-[#697596]/10">
                ...
                <div className="ml-4 text-[0.6875rem] uppercase tracking-widest text-[#8f9fb7]">
              ...
              <div className="flex h-[400px]">
                ...
                <div className="flex-1 p-6 space-y-6">
                  <div className="flex justify-between items-end border-b border-gray-200 pb-4">
                    <div>
                      <div className="text-[0.6875rem] uppercase tracking-widest text-white mb-1">
                        Current Directory
                      </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-4 items-center group/row">
                      ...
                      <div className="bg-gray-100 px-2 py-1 font-mono text-sm text-gray-600 truncate">
                        postgres://admin:••••••@db...
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4 items-center group/row">
                      ...
                      <div className="bg-gray-100 px-2 py-1 font-mono text-sm text-gray-600 truncate">
                        sk_live_51M... <Copy className="float-right text-xs" />
                      </div>
                    </div>
                    <div className="grid grid-cols-2 gap-4 items-center group/row opacity-50">
                      ...
                      <div className="bg-gray-100 px-2 py-1 font-mono text-sm text-gray-600">
                        production
                      </div>
                    </div>
                  </div>
        ...
        <section className="bg-gray-50 py-32 border-y border-gray-200">
          <div className="w-full px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20">
              <div>
                <h2 className="text-3xl font-bold tracking-tighter text-gray-800 mb-6">
                  Developers lose track of env and secrets
                </h2>
                <p className="text-gray-700 leading-relaxed">
                  The modern stack is fragmented. Secrets shouldn't be.
                </p>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600">
                    Variables hidden across local machines, servers, and CI/CD
                    pipelines.
                  </p>
                </div>
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-600">
                    Credentials saved in random notes or Slack messages. Hard to
                    manage separation.
                  </p>
                </div>
              </div>
          ...
          <div className="w-full px-8">
            <div className="text-center mb-20 space-y-4">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Envora isn't just storage - it's a structured system to manage
                environment variables, credentials, and project data without
                losing anything.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">
                    Structured env storage
                  </h3>
                </div>
                <p className="text-gray-600 leading-relaxed">
                  Store your environment variables the same way your project is
                  structured. Create a project, organize it into folders like
                  frontend and backend, and store env files inside them. You can
                  also nest folders as deep as your architecture requires.
                </p>
                <p className="text-gray-600 leading-relaxed mt-3">
                  No more flat lists or messy files - everything stays organized
                  and predictable.
                </p>
              </div>
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">
                    Persistent env backup
                  </h3>
                </div>
                <p className="text-gray-600 leading-relaxed">
                  Your environment variables stay safe even if your project
                  doesn't. Delete a project from your local machine, switch
                  devices, or clean up old repos - your env is still stored and
                  accessible whenever you need it again.
                </p>
                <p className="text-gray-600 leading-relaxed mt-3">
                  Re-clone your code, fetch your env from Envora, and continue
                  working instantly.
                </p>
              </div>
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                <div className="flex items-start gap-4 mb-6">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900">
                    Manual input and .env upload
                  </h3>
                </div>
                <p className="text-gray-600 leading-relaxed">
                  Add variables your way. You can manually create key-value
                  pairs or upload a full .env file and let Envora automatically
                  parse and store everything.
                </p>
                <p className="text-gray-600 leading-relaxed mt-3">
                  Edit, update, or remove variables anytime without dealing with
                  raw files.
                </p>
              </div>
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Store important account details alongside your projects. Save
                  website logins, API keys, and credentials in a structured
                  format with fields like title, website, email/username,
                  password, and notes.
                </p>
                <p className="text-gray-600 leading-relaxed mt-3">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Keep important information where it belongs - with your
                  project. Add notes for setup steps, configurations, reminders,
                  or anything you might forget later.
                </p>
                <p className="text-gray-600 leading-relaxed mt-3">
              ...
              <div className="relative bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Your data is protected by design. All sensitive values are
                  encrypted before being stored, and only you can access them
                  through your authenticated session.
                </p>
                <p className="text-gray-600 leading-relaxed mt-3">
                  Your env, credentials, and notes remain completely private and
            ...
            <div className="text-center mt-16">
              <p className="text-lg text-gray-700 font-medium">
                No more lost env files. No more scattered data. Everything stays
                in one place.
              </p>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 max-w-7xl mx-auto">
              <div className="relative">
                ...
                <p className="text-lg text-gray-600">
                  Initialize your workspace with project-specific scope.
                </p>
              </div>
              <div className="relative">
                ...
                <p className="text-lg text-gray-600">
                  Choose: add env or create folders for logic separation.
                </p>
              </div>
              <div className="relative">
                ...
                <p className="text-lg text-gray-600">
                  Fill in keys and secrets with instant encryption.
                </p>
              </div>
              <div className="relative">
                ...
                <p className="text-lg text-gray-600">
                  Retrieve values via dashboard or upcoming CLI tool.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-40 text-center relative overflow-hidden">
          ...
          <div className="max-w-3xl mx-auto px-8 relative z-10 space-y-8">
            <h2 className="text-5xl font-bold tracking-tighter text-gray-900">
              Stop losing track of your environment variables
            </h2>
            <p className="text-gray-600 text-lg">
              Join developers who prioritize structure and security.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/register"
                className="w-full sm:w-auto bg-blue-600 text-white px-10 py-4 rounded-3xl font-bold hover:bg-blue-700 transition-colors"
              >
                Start Free
              </Link>
              <Link
                to="/login"
                className="w-full sm:w-auto border border-gray-300 px-10 py-4 rounded-3xl font-bold text-gray-700 hover:bg-gray-50 transition-colors"
              >
                Login
              </Link>
            </div>
      ...
      <footer className="bg-[#0a0e18] border-t border-[#3b4766]/15 py-12 px-8">
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="text-[0.6875rem] uppercase tracking-[0.05em] font-bold text-[#c5c7c8]">
              Resources
            </div>
            <ul className="space-y-2">
              <li>
                <a
                  className="text-[0.6875rem] uppercase tracking-[0.05em] text-[#8f9fb7] hover:text-[#c5c7c8] underline decoration-[#8f9fb7]/30 transition-opacity"
                  href="#"
                >
                  Docs
                </a>
